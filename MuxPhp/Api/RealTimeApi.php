...
class RealTimeApi
{
     ...
     */
    public function getRealtimeHistogramTimeseries($realtime_metric_id, $filters = null)
    {
        list($response) = $this->getRealtimeHistogramTimeseriesWithHttpInfo($realtime_metric_id, $filters);
        return $response;
    }
     ...
     */
    public function getRealtimeHistogramTimeseriesWithHttpInfo($realtime_metric_id, $filters = null)
    {
        $request = $this->getRealtimeHistogramTimeseriesRequest($realtime_metric_id, $filters);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRealtimeHistogramTimeseriesAsync($realtime_metric_id, $filters = null)
    {
        return $this->getRealtimeHistogramTimeseriesAsyncWithHttpInfo($realtime_metric_id, $filters)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRealtimeHistogramTimeseriesAsyncWithHttpInfo($realtime_metric_id, $filters = null)
    {
        $returnType = '\MuxPhp\Models\GetRealTimeHistogramTimeseriesResponse';
        $request = $this->getRealtimeHistogramTimeseriesRequest($realtime_metric_id, $filters);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRealtimeHistogramTimeseriesRequest($realtime_metric_id, $filters = null)
    {
        // verify the required parameter 'realtime_metric_id' is set
        if ($realtime_metric_id === null || (is_array($realtime_metric_id) && count($realtime_metric_id) === 0)) {
            throw new \InvalidArgumentException(
