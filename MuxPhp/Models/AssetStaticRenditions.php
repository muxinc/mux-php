 ...
 * @package  MuxPhp
 */
class AssetStaticRenditions implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Asset_static_renditions';
    ...
    {
        $this->container['status'] = isset($data['status']) ? $data['status'] : 'disabled';
     ...
     * Sets files
     *
     * @param \MuxPhp\Models\AssetStaticRenditionsFiles[]|null $files files
     *
     * @return $this
     */
