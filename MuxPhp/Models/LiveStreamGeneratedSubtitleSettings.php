...
class LiveStreamGeneratedSubtitleSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transcription_vocabulary_ids', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTranscriptionVocabularyIds($transcription_vocabulary_ids)
    {
        ...
        if (is_null($transcription_vocabulary_ids)) {
            throw new \InvalidArgumentException('non-nullable transcription_vocabulary_ids cannot be null');
        }
