...
use MuxPhp\Models\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\MuxPhp\Model\\' . $data->{$discriminator};
    ...
    public static function buildBetterQuery($queryParams) {
        if (!is_array($queryParams)) {
            throw new \InvalidArgumentException('$queryParams must be an array.');
        }
        ...
        foreach ($queryParams as $key => $value) {
            if (is_array($value)) {
                foreach ($value as $subValue) {
                    array_push($parts, $key . "[]" . "=" . urlencode($subValue));
                }
            } else {
                array_push($parts, $key . "=" . urlencode($value));
            }
        }
