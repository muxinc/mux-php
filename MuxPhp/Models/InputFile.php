 ...
 */
class InputFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('container_format', $data ?? [], null);
    ...
    */
    ...
    public function setContainerFormat($container_format)
    {
        ...
        if (is_null($container_format)) {
            throw new \InvalidArgumentException('non-nullable container_format cannot be null');
        }
