...
class LiveStreamEmbeddedSubtitleSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string|null $name A name for this live caption stream.
     *
     * @return self
     */
     ...
     * Sets passthrough
     *
     * @param string|null $passthrough Arbitrary metadata set for the live stream caption track. Max 255 characters.
     *
     * @return self
     */
     ...
     * Sets language_code
     *
     * @param string|null $language_code The language of the caption stream. Value must be BCP 47 compliant.
     *
     * @return self
     */
