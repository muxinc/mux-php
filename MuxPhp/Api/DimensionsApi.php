...
class DimensionsApi
{
     ...
     */
    public function listDimensionValues($dimension_id, $optionalParams = [])
    {
        list($response) = $this->listDimensionValuesWithHttpInfo($dimension_id, $optionalParams);
        return $response;
    }
     ...
     */
    public function listDimensionValuesWithHttpInfo($dimension_id, $optionalParams = [])
    {
        $request = $this->listDimensionValuesRequest($dimension_id, $optionalParams);
     ...
     */
    public function listDimensionValuesAsync($dimension_id, $optionalParams = [])
    {
        return $this->listDimensionValuesAsyncWithHttpInfo($dimension_id, $optionalParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDimensionValuesAsyncWithHttpInfo($dimension_id, $optionalParams = [])
    {
        $returnType = '\MuxPhp\Models\ListDimensionValuesResponse';
        $request = $this->listDimensionValuesRequest($dimension_id, $optionalParams);
     ...
     */
    protected function listDimensionValuesRequest($dimension_id, $optionalParams)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listDimensionsRequest()
    {
