...
/**
 * SigningKeysApi Class Doc Comment
 *
 * @category Class
 * @package  MuxPhp
 * @author   Mux API team
...
class SigningKeysApi
{
    ...
    {
        list($response) = $this->createSigningKeyWithHttpInfo();
        return $response;
    }
     ...
     */
    public function createSigningKeyWithHttpInfo()
    {
        $request = $this->createSigningKeyRequest();
     ...
     */
    public function createSigningKeyAsync()
    {
        return $this->createSigningKeyAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSigningKeyAsyncWithHttpInfo()
    {
        $returnType = '\MuxPhp\Models\SigningKeyResponse';
        $request = $this->createSigningKeyRequest();
     ...
     */
    public function createSigningKeyRequest()
    {

        $resourcePath = '/system/v1/signing-keys';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function deleteSigningKey($signing_key_id)
    {
        $this->deleteSigningKeyWithHttpInfo($signing_key_id);
    }

    /**
     * Operation deleteSigningKeyWithHttpInfo
     *
     * Delete a signing key
     *
     * @param  string $signing_key_id The ID of the signing key. (required)
     ...
     */
    public function deleteSigningKeyWithHttpInfo($signing_key_id)
    {
        $request = $this->deleteSigningKeyRequest($signing_key_id);
    ...
    /**
     * Operation deleteSigningKeyAsync
     *
     * Delete a signing key
     *
     * @param  string $signing_key_id The ID of the signing key. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSigningKeyAsync($signing_key_id)
    {
        return $this->deleteSigningKeyAsyncWithHttpInfo($signing_key_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteSigningKeyAsyncWithHttpInfo
     *
     * Delete a signing key
     *
     * @param  string $signing_key_id The ID of the signing key. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSigningKeyAsyncWithHttpInfo($signing_key_id)
    {
        $returnType = '';
        $request = $this->deleteSigningKeyRequest($signing_key_id);
    ...
    /**
     * Create request for operation 'deleteSigningKey'
     *
     * @param  string $signing_key_id The ID of the signing key. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSigningKeyRequest($signing_key_id)
    {
        ...
        if ($signing_key_id === null || (is_array($signing_key_id) && count($signing_key_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $signing_key_id when calling deleteSigningKey'
            );
        }

        $resourcePath = '/system/v1/signing-keys/{SIGNING_KEY_ID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function listSigningKeys($limit = 25, $page = 1)
    {
        list($response) = $this->listSigningKeysWithHttpInfo($limit, $page);
        return $response;
    }

    /**
     * Operation listSigningKeysWithHttpInfo
     *
     * List signing keys
     *
     * @param  int $limit Number of items to include in the response (optional, default to 25)
     ...
     */
    public function listSigningKeysWithHttpInfo($limit = 25, $page = 1)
    {
        $request = $this->listSigningKeysRequest($limit, $page);
    ...
    /**
     * Operation listSigningKeysAsync
     *
     * List signing keys
     *
     * @param  int $limit Number of items to include in the response (optional, default to 25)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSigningKeysAsync($limit = 25, $page = 1)
    {
        return $this->listSigningKeysAsyncWithHttpInfo($limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listSigningKeysAsyncWithHttpInfo
     *
     * List signing keys
     *
     * @param  int $limit Number of items to include in the response (optional, default to 25)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSigningKeysAsyncWithHttpInfo($limit = 25, $page = 1)
    {
        $returnType = '\MuxPhp\Models\ListSigningKeysResponse';
        $request = $this->listSigningKeysRequest($limit, $page);
    ...
    /**
     * Create request for operation 'listSigningKeys'
     *
     * @param  int $limit Number of items to include in the response (optional, default to 25)
     * @param  int $page Offset by this many pages, of the size of &#x60;limit&#x60; (optional, default to 1)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listSigningKeysRequest($limit = 25, $page = 1)
    {
